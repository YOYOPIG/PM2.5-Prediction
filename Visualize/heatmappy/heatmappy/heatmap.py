...
class Heatmapper:
    def __init__(self, point_diameter=400, point_strength=0.2, opacity=0.65,
                 colours='default',
                 grey_heatmapper='PIL'):
        """
...
if __name__ == '__main__':
    ...
    example_img = Image.open(_asset_file('ncku.jpg'))
    xPos = 320
    yPos = 300
    example_points = [(xPos, yPos),(xPos, yPos),(xPos, yPos),(xPos, yPos),(xPos, yPos),
                      (xPos-200, yPos),(xPos-200, yPos),(xPos-200, yPos),(xPos-200, yPos)]

    heatmapper = Heatmapper(colours='default')
    heatmapper.colours = 'default'
