...
# Declare widgets
button_dl_data = tk.Button(window, image = dl_icon, compound = LEFT, command=download_data, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_scatter = tk.Button(window, image = scatter_icon, compound = LEFT, command=plt_scatter_one_pos, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_line = tk.Button(window, image = line_icon, compound = LEFT, command=plot_line_chart, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_detail = tk.Button(window, image = detail_icon, compound = LEFT, command=plot_scatter_time, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_corr = tk.Button(window, image = corr_icon, compound = LEFT, command=plot_corr, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_box = tk.Button(window, image = box_icon, compound = LEFT, command=plot_boxplot, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
button_map = tk.Button(window, image = map_icon, compound = LEFT, command=animation_on_map, bd = 0, bg = bg_color, activeforeground=fg_color, activebackground=bg_color)
